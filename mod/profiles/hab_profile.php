...
class HabilitarPerfil
{
	var $conexion;
	
	function HabilitarPerfil( $conexion )
	{
	...
	function Listar()
	{
		...
		echo "<h2 style='text-align:left' >Listado de Perfiles Disponibles para Activar</h2>";
		echo "<br>";
		...
		{
			echo "<tr>";
			echo "<td class='cellInfo' align='left' colspan='3' >No se encontraron perfiles disponibles para Activar</td>";
			echo "</tr>";
		}
		echo "</table>";
	}
	...
	function Activar()
	{
		...
		MessageOk( "El Perfil <b>$_POST[nomPerfil]</b> se Activo Exitosamente." );
	...
	function Form()
	{
		...
		$form -> Button( "Activar", array( "onclick" => "ActivarPerfil()" ) );
		echo "</div>";
...
$action = new HabilitarPerfil( $this -> conexion );
