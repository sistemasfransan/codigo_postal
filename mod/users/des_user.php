...
class DeshabilitarUsuario
{
	...
	function DeshabilitarUsuario( $conexion )
	{
	...
	function Listar()
	{
		...
		echo "<h2 style='text-align:left' >Listado de Usuarios para Desactivar</h2>";
		echo "<br>";
		...
		{
			echo "<tr>";
			echo "<td class='cellInfo' align='left' colspan='3' >No se encontraron Usuarios disponibles para Desactivar</td>";
			echo "</tr>";
		}		
		echo "</table>";
	}
	...
	function Desactivar()
	{
		...
		MessageOk( "El Usuario <b>$_POST[nomUsuario]</b> se Desactivo Exitosamente." );
	...
	function Form()
	{
		...
		$form = new Form( array( "name" => "form" ) );
		$form -> Panel( "Desactivar Usuario", "100%" );
		...
		$form -> Button( "Desactivar", array( "onclick" => "DesactivarUsuario()" ) );
		echo "</div>";
...
$action = new DeshabilitarUsuario( $this -> conexion );
