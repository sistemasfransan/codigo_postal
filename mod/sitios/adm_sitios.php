...
{	
	...
	var $nombre = "Sitio";
	var $nombres = "Sitios";
	var $mensaje = "El Sitio";
	var $columnas = array( "Código Sitio", "Nombre Sitio" );
	var $campos = array( "codSitio", "nomSitio" );
	...
	function Vista( $titulo , $boton , $state )
	{
		...
		$form -> Row();
		$form -> Label( array( "label" => $this -> columnas[0], "for" => $this -> campos[0] ) );
		$form -> TextField( array( "maxlenght" => "3", "size" => "3" , "name" => $this -> campos[0],  "value" => $_POST[$this -> campos[0]], "onchange" => $onchange ) );
